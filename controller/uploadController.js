...
//=========== 
  const newdata={
    agentName:data.agentName
       ...
       const agent=new Agent(newdata)
const agentresult=await agent.save()
// =============accounts section====================
...
// =============policies section====================
policiesData.agentId=agentresult._id
policiesData.accountId=accountsResult._id
policiesData.userId=userResult._id
policiesData.carrierId=carriersResult._id
policiesData.lobId=lobResult._id
